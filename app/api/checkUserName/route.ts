...
//         const check = await normalUser.find({ userName })
//         const check2 = await googleUser.find({ userName })

//         if (check.length > 0 || check2.length > 0) {
//             return NextResponse.json({ success: false, msg: "User Name is already taken." }, { status: 400 })
...
//         // }
//         // else {
//             return NextResponse.json({ success: true, msg: "username cookie added" }, { status: 201 })
//         // }
